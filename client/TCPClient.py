...
def main():
    ...
    parser.add_argument('-s', '--serverAddress', type=int, help='Specify the address of the tcp client to connect to')
    parser.add_argument('-p', '--port', type=int, help='Specify the port of of the server that is listeneing for tcp packets')
